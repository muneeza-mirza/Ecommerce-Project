...
<?php 
  ...
  $query="select * from `addpro` where cate='bridal'";
  $catFil = " cate= 'bridal' ";
  $catVal = false;
      ...
      <nav class="navbar navbar-expand-lg navbar-light"> <a class="navbar-brand" href="#"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="nav navbar-nav ml-auto under">
            ...
            <li class="nav-item nav-item-active"> <a class="nav-link" href="http://localhost/project/product_bridal.php">Bridal Shoes</a> </li>
