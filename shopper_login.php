...
if(isset($_POST['btn'])){
	...
	$query="select * from `shopper` where email='$email' and pass='$pass' AND status = 1";
	$dis=mysqli_query($con,$query) or die(mysqli_error());
	while($row=mysqli_fetch_array($dis)){
		$_SESSION['shopper']=$row['fname'];
		$_SESSION['shopperId']=$row['id'];
	}
	...
	<div class="container">
		...
		<div class="col-md-12">
			...
			<div class="headl animated fadeInDownBig">
				...
				<div class="col-md-12 em" align="center"><a href="shopper_Registration.php" class="col-form-label-sm empegl">Registration an Account</a></div>
