...
<title>Update Product</title>
	...
	<style>
		.ubtn{background-color:white;}
		.bcol{border:1px solid #eeeeee;}
	</style>
</head>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="width:165px;">
		 <img src="upload/<?php echo $img;?>" alt="khini_image" height="80px" width="165px"/></td>
	  ...
	  <td><?php echo $date;?></td>
		...
		<td class="h_highu bcol"> <a href="product updated.php?update=<?php echo $id;?>" id="anker_link"> Update </a> </td>
    </tr>
	 <?php
	  };?>
  </tbody>
