...
<header><div class="row" style="width:100%!important; padding: 0px 0px 0px 20px;">
	...
	<div class="row">
		...
		<ul class="side_bar">
			...
			<h6 class="user_name"><?php
				if(isset($_SESSION['registration'])){
					echo $nam=$_SESSION['registration'];
				}
?></h6>Administrator
			</li>
			...
			<li class="side_bar_line"><a href="delete product.php" class="side_bar1" style="color:#F8F8F9 !important;"><i class="fa fa-trash-alt icon_side_bar"></i>Delete Product</a></li>
  ...
  <tbody>
    ...
    <tr>
	  ...
	  <td><?php echo $date;?></td>
		<td class="h_high"> <a href="delete_product.php?delete=<?php echo $id;?>" id="anker_link"> Delete </a></td>
    </tr>
	  <?php
	  };?>
