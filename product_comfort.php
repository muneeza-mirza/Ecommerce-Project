...
<?php 
  ...
  $query="select * from `addpro` where cate='comfort'";
  $catFil = " cate= 'comfort' ";
  $catVal = false;
      ...
      <nav class="navbar navbar-expand-lg navbar-light"> <a class="navbar-brand" href="#"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="nav navbar-nav ml-auto under">
            ...
            <li class="nav-item nav-item-active"> <a class="nav-link" href="http://localhost/project/product_comfort.php">Comfort shoes</a> </li>
