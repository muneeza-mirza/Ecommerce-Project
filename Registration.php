...
if(isset($_POST['btn'])){
	...
	$query="INSERT INTO `registration` (`id`, `fname`, `lname`, `img`, `email`, `tele`, `gender`, `day`, `month`, `year`, `pass`, `cpass`, `date`) VALUES('','$fname','$lname','$filen','$email','$tele','$gender','$day','$month','$year','$pass','$cpass',now())";
