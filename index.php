...
<?php 
  ...
  $query="select * from `addpro` where cate='m_shoes'";
  $catFil = " cate= 'casual' ";
  $catVal = false;
    ...
    <div class="container-fluid">
      <div class="row"> 
        ...
        <!-- zeeshan shop cart code -->
			  <?php 
        function getProductRatingStar($id)
        {
          global $con;
          $queryavrRating="select ROUND(AVG(rating), 0) AS avrRating from `rating` where usrId > 0 and prodId ='". $id. "' ";
        ...
        <!-- zeeshan shop cart code -->
            ...
            <?php echo '<span>'.getProductRatingStar($id).'</span>'; ?>
